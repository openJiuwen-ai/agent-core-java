...
/**
 * Mirrors the 830 {@code fileguard/FileGuardConfigNormalizerTest}, adapted to the flat
 * {@code harness.security} package. Path assertions are lexical (the normalizer never
 * touches the filesystem), so literal posix paths stay stable across operating systems.
 */
