...
class CheckpointerFactorySpiTest {
    ...
    @Test
    @DisplayName("create(CheckpointerConfig) with null uses empty CheckpointerConfig defaults")
    void createWithNullConfigDefaultsToEmptyConfig() {
        Checkpointer checkpointer = CheckpointerFactory.create((CheckpointerConfig) null);
