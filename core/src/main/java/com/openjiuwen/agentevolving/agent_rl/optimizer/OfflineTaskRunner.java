...
import com.openjiuwen.agentevolving.agent_rl.DatasetFactory;
import com.openjiuwen.agentevolving.agent_rl.offline.MainTrainer;
...
public class OfflineTaskRunner extends BaseTaskRunner {
    ...
    private static Function<com.openjiuwen.agentevolving.agent_rl.schemas.RolloutMessage, Map<String, Object>>
            castRolloutRewardFn(Function<?, Map<String, Object>> rewardFn) {
        return (Function<com.openjiuwen.agentevolving.agent_rl.schemas.RolloutMessage, Map<String, Object>>) rewardFn;
    }
