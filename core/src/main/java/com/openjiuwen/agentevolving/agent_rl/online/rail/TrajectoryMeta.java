...
/**
 * Mirrors Python's {@code TrajectoryMeta} in
...
public class TrajectoryMeta {
    ...
    public TrajectoryMeta(String trajectoryId,
                          String sessionId,
                          String status,
                          int totalTurns,
                          double startedAt,
    ...
    public static final class Builder {
        ...
        private double startedAt = System.currentTimeMillis() / 1000.0d;
        private double endedAt = System.currentTimeMillis() / 1000.0d;
