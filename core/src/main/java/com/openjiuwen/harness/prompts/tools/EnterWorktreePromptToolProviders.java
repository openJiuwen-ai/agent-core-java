...
/**
 * Mirrors Python's {@code openjiuwen.harness.prompts.tools.enter_worktree} in
 * {@code openjiuwen/harness/prompts/tools/enter_worktree.py}.
 */
public final class EnterWorktreePromptToolProviders {

    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    private static final TypeReference<Map<String, Object>> MAP_TYPE = new TypeReference<>() {
    };

    private EnterWorktreePromptToolProviders() {
    }
    ...
    public static final class EnterWorktreeMetadataProvider implements ToolMetadataProvider {
        ...
        public String getDescription(String language) {
            return resolve(ENTERWORKTREEMETADATAPROVIDER_DESCRIPTION_CN, ENTERWORKTREEMETADATAPROVIDER_DESCRIPTION_EN, language);
        }

        @Override
        public Map<String, Object> getInputParams(String language) {
            return parseSchema(resolve(ENTERWORKTREEMETADATAPROVIDER_SCHEMA_CN, ENTERWORKTREEMETADATAPROVIDER_SCHEMA_EN, language));
        }
    }
