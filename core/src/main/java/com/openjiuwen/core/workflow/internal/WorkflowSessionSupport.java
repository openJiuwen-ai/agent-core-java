...
public final class WorkflowSessionSupport {
    ...
    public static String interact(BaseSession session, Object question) {
        ...
        Object wrapped = new NodeSessionApi(session).interact(question);
    ...
    public static String userLatestInput(BaseSession session, Object question) {
        ...
        if (value == InvokeResult.NOT_FOUND && session != null) {
            Object wrapped = new NodeSessionApi(session).userLatestInput(question);
            return wrapped == null ? "" : String.valueOf(wrapped);
        }
