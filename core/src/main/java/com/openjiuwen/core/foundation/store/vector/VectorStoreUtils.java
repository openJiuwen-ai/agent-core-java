...
public final class VectorStoreUtils {
    ...
    private static CollectionSchema computeSchemaAddField(CollectionSchema schema, Object operation) {
    ...
    private static CollectionSchema computeSchemaRenameField(CollectionSchema schema, Object operation) {
    ...
    private static CollectionSchema computeSchemaUpdateFieldType(CollectionSchema schema, Object operation) {
    ...
    private static CollectionSchema computeSchemaUpdateVectorDim(CollectionSchema schema, Object operation) {
        String fieldName = stringProperty(operation, "fieldName", "field_name");
        CollectionSchema newSchema = CollectionSchema.fromDict(schema.toDict());
        FieldSchema field = newSchema.getField(fieldName);
        if (field == null) {
    ...
    private static Map<String, Object> applyOperationToDoc(Map<String, Object> doc, Object operation) {
        String kind = operationKind(operation);
        if ("AddScalarFieldOperation".equals(kind)) {
            String fieldName = stringProperty(operation, "fieldName", "field_name");
    ...
    private static void applyEmbeddingDimensionUpdate(Map<String, Object> doc, Object operation) {
    ...
    private static String operationKind(Object operation) {
