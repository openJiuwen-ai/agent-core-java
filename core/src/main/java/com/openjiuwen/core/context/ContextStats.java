...
public class ContextStats {
    ...
    public static final class Builder {
        ...
        public Builder totalDialogues(int totalDialogues) {
            stats.setTotalDialogues(totalDialogues);
            return this;
        }

        public Builder systemMessages(int systemMessages) {
            stats.setSystemMessages(systemMessages);
            return this;
        }
        ...
        public Builder assistantMessages(int assistantMessages) {
            stats.setAssistantMessages(assistantMessages);
            return this;
        }

        public Builder toolMessages(int toolMessages) {
            stats.setToolMessages(toolMessages);
            return this;
        }

        public Builder tools(int tools) {
            stats.setTools(tools);
            return this;
        }

        public ContextStats build() {
            return stats;
        }
    }
