...
/**
 * CompletableFuture/list bridge for vector-store compatibility APIs.
 *
 * @param <T> element type
 */
public class CompletableList<T> extends CompletableFuture<List<T>> implements List<T> {

    public CompletableList(CompletableFuture<? extends List<T>> delegate) {
    ...
    public static <T> CompletableList<T> completed(List<T> value) {
        return new CompletableList<>(CompletableFuture.completedFuture(value == null ? List.of() : value));
    }
