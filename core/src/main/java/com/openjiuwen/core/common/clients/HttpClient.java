...
public class HttpClient extends BaseClient {
    ...
    /**
     * Create a client from registry keyword arguments.
     *
     * @param kwargs recognizes {@code config} and {@code reuse_session}
     */
    public HttpClient(Map<String, Object> kwargs) {
        this(sessionConfigFrom(kwargs), reuseSessionFrom(kwargs));
    }
    ...
    private static SessionConfig sessionConfigFrom(Map<String, Object> kwargs) {
        if (kwargs == null) {
            return new SessionConfig();
        }
        Object config = kwargs.get("config");
        if (config instanceof SessionConfig sessionConfig) {
    ...
    private static boolean reuseSessionFrom(Map<String, Object> kwargs) {
        if (kwargs == null) {
            return true;
        }
        Object value = kwargs.get("reuse_session");
        if (value instanceof Boolean isReuseEnabled) {
            return isReuseEnabled;
        }
        return true;
    }
