...
/**
 * Dynamic transport and storage registries for team blueprints.
 */
public final class TeamBlueprintRegistry {
    ...
    static void ensureBuiltinInfraRegistered() {
        if (TRANSPORT_REGISTRY.isEmpty()) {
            TRANSPORT_REGISTRY.put("inprocess", TeamBlueprintRegistry::messagerTransportConfig);
            TRANSPORT_REGISTRY.put("pyzmq", TeamBlueprintRegistry::messagerTransportConfig);
        }
        if (STORAGE_REGISTRY.isEmpty()) {
            STORAGE_REGISTRY.put("sqlite", TeamBlueprintRegistry::databaseConfig);
            STORAGE_REGISTRY.put("postgresql", TeamBlueprintRegistry::databaseConfig);
            STORAGE_REGISTRY.put("mysql", TeamBlueprintRegistry::databaseConfig);
            STORAGE_REGISTRY.put("memory", TeamBlueprintRegistry::dynamicConfigMap);
        }
    }
