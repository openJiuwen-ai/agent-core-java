...
public class TeamMemoryConfig {
    ...
    /**
     * Resolves the configured embedding model, including the supported environment fallback.
     *
     * @param config team memory configuration
     * @return the embedding configuration, or {@code null} when none is configured
     * @since 0.1.7
     */
