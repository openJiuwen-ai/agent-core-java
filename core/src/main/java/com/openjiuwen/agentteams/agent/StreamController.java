...
public class StreamController {
    ...
    private final Supplier<AgentSessionApi> sessionGetter;
    ...
    public StreamController(
            ...
            Supplier<AgentSessionApi> sessionGetter) {
        this(
                deepAgentGetter,
                memberNameGetter,
                statusUpdater,
    ...
    private String resolveSessionId() {
        AgentSessionApi session = sessionGetter.get();
        return session != null ? session.getSessionId() : null;
    }

    private AgentSessionApi resolveAgentSessionApi() {
        return sessionGetter.get();
    }
    ...
    private Set<String> pendingInterruptIds() {
        ...
        return interruptionState.getInterruptedTools().values().stream()
