...
public class TeamAgent implements DispatcherHost {
    ...
    public Map<String, Object> dispatchTask(String query) {
        ...
        Loggers.AGENT.info("dispatchTask: member={} lifecycle={} query={}",
    ...
    public SpawnAgentConfig buildSpawnConfig(TeamRuntimeContext ctx) {
        ...
        SpawnAgentConfig spawnConfig = new SpawnAgentConfig(SpawnAgentKind.TEAM_AGENT);
        spawnConfig.setRunnerConfig(SpawnAgentConfigs.serializeRunnerConfig(RunnerConfig.getRunnerConfig()));
        spawnConfig.setLoggingConfig(Map.of("member_name", ctx.getMemberName()));
        spawnConfig.setPayload(payload);
        return spawnConfig;
    }
    ...
    public Map<String, Object> buildSpawnConfigPayload(TeamRuntimeContext ctx) {
        return buildSpawnConfig(ctx).toMap();
    }
    ...
    private void initializeAgentSession() {
        this.agentSession = com.openjiuwen.core.session.AgentSession.createAgentSession(
                context.getSessionId(), null, null);
    ...
    private void applySessionId(String sessionId) {
        ...
        context.setSessionId(sessionId);
        agentSession = com.openjiuwen.core.session.AgentSession.createAgentSession(sessionId, null, null);
