...
/**
 * Prompt constants for workflow-agent building.
 *
...
public final class WorkflowPrompts {
    ...
    public static final PromptTemplate INITIAL_INTENTION_USER_TEMPLATE = PromptTemplate.builder()
    ...
    public static final PromptTemplate REFINE_INTENTION_USER_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("\n" + """
                    ## 输入信息
    ...
    public static final PromptTemplate CHECK_CYCLE_USER_PROMPT_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("\n" + """
                    ## 流程图
                    {{mermaid_code}}
                    """)))
