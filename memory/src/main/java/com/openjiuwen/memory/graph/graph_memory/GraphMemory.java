...
import com.openjiuwen.memory.graph.extraction.AIEntity;
import com.openjiuwen.memory.graph.extraction.EntityDeclaration;
import com.openjiuwen.memory.graph.extraction.EntityDef;
import com.openjiuwen.memory.graph.extraction.EntityDuplication;
import com.openjiuwen.memory.graph.extraction.EntityExtraction;
...
import com.openjiuwen.memory.graph.extraction.HumanEntity;
import com.openjiuwen.memory.graph.extraction.MergeRelations;
import com.openjiuwen.memory.graph.extraction.ParseResponse;
import com.openjiuwen.memory.graph.extraction.RelationExtraction;
import com.openjiuwen.memory.graph.extraction.RelevantFacts;
import com.openjiuwen.memory.graph.extraction.TimezonePredictions;
...
public class GraphMemory {
    ...
    public States.GraphMemUpdate addMemory(EpisodeType srcType, String userId, Object content,
        ...
        try {
            ...
            Object timezoneInfo = ParseResponse.parseJson(timezoneResponse.getContentAsString(),
                    com.openjiuwen.memory.graph.extraction.MultilingualBaseModel
            ...
            Object relationParsed = ParseResponse.parseJson(relationResponse.getContentAsString(),
                    com.openjiuwen.memory.graph.extraction.MultilingualBaseModel.responseFormat(
    ...
    private States.GraphMemState initState(OffsetDateTime referenceTime) {
        ...
        state.getPrompting().setSchemaEntityExtraction(com.openjiuwen.memory.graph.extraction.MultilingualBaseModel
                .responseFormat(EntitySummary.class, language));
        state.getPrompting().setSchemaEntityDedupe(com.openjiuwen.memory.graph.extraction.MultilingualBaseModel
                .responseFormat(EntityDuplication.class, state.getPrompting().getEntityDedupeLanguage()));
        state.getPrompting().setSchemaRelationMerge(com.openjiuwen.memory.graph.extraction.MultilingualBaseModel
                .responseFormat(MergeRelations.class, language));
        state.getPrompting().setSchemaRelationFilter(com.openjiuwen.memory.graph.extraction.MultilingualBaseModel
    ...
    private EntityDeclarationResult extractEntityDeclarations(EpisodeType srcType, String content,
        ...
        Object parsed = ParseResponse.parseJson(response.getContentAsString(),
                com.openjiuwen.memory.graph.extraction.MultilingualBaseModel.responseFormat(EntityExtraction.class,
