...
class SubagentsCompatibilityTest {
    ...
    void createCodeResearchAndVerificationAgentsShouldReturnDeepAgents() {
        ...
        assertThat(code.getConfig().getRails()).anyMatch(SysOperationRail.class::isInstance)
                .anyMatch(AgentModeRail.class::isInstance)
                .anyMatch(AskUserRail.class::isInstance)
                .anyMatch(ConfirmInterruptRail.class::isInstance)
                .anyMatch(CodingMemoryRail.class::isInstance);
