...
| 页面 | 关注点 | 主要依据 | 说明 |
| --- | --- | --- | --- |
| [知识检索](知识检索.md) | 知识库、索引、检索与重排 | `com.openjiuwen.retrieval`、`examples/retrieval` | 以 Java retrieval API 和示例入口为准。 |
| [记忆引擎](记忆引擎.md) | 长期记忆、作用域配置、记忆检索 | `com.openjiuwen.memory` | 结合 memory 根包与管理子包理解。 |
