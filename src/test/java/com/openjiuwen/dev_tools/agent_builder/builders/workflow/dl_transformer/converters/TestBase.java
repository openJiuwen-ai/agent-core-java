 ...
 *
 * <p>Note: Converter tests require transformer infrastructure.
 * Tests are disabled pending full implementation.
 */
@Disabled("Converter tests require transformer infrastructure")
class TestBase {

    // Placeholder for base converter tests
}