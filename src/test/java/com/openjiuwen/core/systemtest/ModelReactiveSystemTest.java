...
class ModelReactiveSystemTest extends SystemTestSupport {
    ...
    void testModelInvokeAsyncWithRemoteModel() {
        ...
        StepVerifier.create(model.invokeAsync(
    ...
    void testModelStreamAsyncWithRemoteModel() {
        ...
        StepVerifier.create(model.streamAsync(
                                List.of(new UserMessage("Reply with the exact token MODEL_STR_OK.")),
                                null,
                                0.0f,
                                0.9f,
                                null,
