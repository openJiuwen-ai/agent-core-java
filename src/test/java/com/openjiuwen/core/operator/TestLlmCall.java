...
class TestLlmCall {
    ...
    class LlmCallTests {
        ...
        void testSetParameterFrozenSystemPrompt() {
            LLMCallOperator op = new LLMCallOperator("test_model", null, "original", "{{query}}",
                    true, false, "llm_call", null);
        ...
        void testSetParameterFrozenUserPrompt() {
            LLMCallOperator op = new LLMCallOperator("test_model", null, "sys", "original {{query}}",
                    false, true, "llm_call", null);
        ...
        void testLoadStateTriggersCallback() {
            ...
            LLMCallOperator op = new LLMCallOperator("test_model", null, "original system", "original {{query}}",
        ...
        private LLMCallOperator createOperator() {
            return new LLMCallOperator("test_model", null, "You are a helpful assistant.", "Answer: {{query}}",
                    false, false, "llm_call", null);
        }
    }
}
