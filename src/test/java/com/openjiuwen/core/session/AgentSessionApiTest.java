...
class AgentSessionApiTest {
    ...
    class StateOps {
        ...
        void testSessionId() {
            AgentSession session = new AgentSession("test-id-123", null, null);
        ...
        void testEnvVars() {
            AgentSession session = new AgentSession("test", Map.of("env_key", "env_val"), null);
        ...
        void testGetEnvDefault() {
            AgentSession session = new AgentSession("test", null, null);
        ...
        void testStreamIterator() {
            AgentSession session = new AgentSession("stream-test", null,
                    new com.openjiuwen.core.singleagent.schema.AgentCard("test-agent", "Test Agent", "1.0"));
    ...
    class NodeSessionApiOps {
        ...
        void testUpdateAndCommit() {
            ...
            WorkflowSession wf = new WorkflowSession("wf1", null, null, state, (Object) null);
