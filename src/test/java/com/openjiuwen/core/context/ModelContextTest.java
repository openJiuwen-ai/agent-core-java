...
class ModelContextTest {
    ...
    class AddMessages {
        ...
        void testAddOneMessage() {
            ...
            List<BaseMessage> result = context.addMessages(new UserMessage("test")).toCompletableFuture().join();
        ...
        void testAddBatchMessages() {
            ...
            List<BaseMessage> result = context.addMessages(msgList).toCompletableFuture().join();
    ...
    class ReloaderToolTests {
        ...
        @Test
        @DisplayName("reloader tool name contains session or context")
        void testReloaderToolName() {
            ModelContext context = createContext();
