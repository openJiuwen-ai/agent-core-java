...
class RemoteClientReactiveTest {
    ...
    void invokeMonoDefaultDelegatesToInvoke() {
        ...
        StepVerifier.create(client.invokeAsync(Map.of(), 1.0))
                .expectNext("ok")
                .verifyComplete();
    }
    ...
    void invokeMonoDefaultPropagatesExceptionUnwrapped() {
        ...
        StepVerifier.create(client.invokeAsync(Map.of(), null))
    ...
    void streamFluxDefaultEmitsAllItemsInOrder() {
        ...
        StepVerifier.create(client.streamAsync(Map.of(), null))
                .expectNext("a", "b", "c")
                .verifyComplete();
    }
    ...
    void streamFluxDefaultCancellationStopsIteration() throws Exception {
        ...
        StepVerifier.create(client.streamAsync(Map.of(), null), 4)
                .expectNextCount(4)
                .thenCancel()
