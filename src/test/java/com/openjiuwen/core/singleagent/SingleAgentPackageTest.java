...
class SingleAgentPackageTest {
    ...
    void exportResolutionIncludesSessionFactoryAndLegacyCompatibilityName() {
        assertEquals("com.openjiuwen.core.singleagent.schema.AgentCard",
        ...
        assertEquals("com.openjiuwen.core.singleagent.legacy.LegacyBaseAgent",
                SingleAgentPackage.resolveExport("LegacyBaseAgent"));
        assertEquals("com.openjiuwen.core.singleagent.AddAbilityResult",
