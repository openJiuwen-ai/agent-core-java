...
/**
 * Tests for LlmAgent with interrupt.
 * 
 * <p>Mirrors Python's {@code test_llm_agent_with_interrupt} in
 * {@code tests.unit_tests.agent.llm_agent.test_llm_agent_with_interrupt}.</p>
 */
...
class TestLlmAgentWithInterrupt {
    ...
    @Test
    @Tag("level0")
    @DisplayName("Test ReAct agent invoke with workflow interrupt")
    ...
    @Test
    @Tag("level0")
    @DisplayName("Test workflow agent invoke with workflow interrupt")
    ...
    @Test
    @Tag("level0")
    @DisplayName("Test workflow agent stream with workflow interrupt")
