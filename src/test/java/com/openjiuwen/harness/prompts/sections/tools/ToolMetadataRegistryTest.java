...
class ToolMetadataRegistryTest {
    private static final java.util.List<String> PYTHON_BUILT_IN_TOOL_NAMES = java.util.List.of(
            "ask_user",
            "bash",
            "powershell",
            "audio_transcription",
    ...
    void registryShouldExposeFilesystemMetadata() {
        ...
        assertThat(grepProps).containsKeys(
                "pattern",
                "path",
                "ignore_case",
                "glob",
    ...
    void registryShouldBuildAllPythonBuiltinToolCards() {
        for (String toolName : PYTHON_BUILT_IN_TOOL_NAMES) {
            ...
            assertThat(cnCard.getInputParams()).as(toolName + " cn schema").containsKeys("type", "properties", "required");
            assertThat(enCard.getInputParams()).as(toolName + " en schema").containsKeys("type", "properties", "required");
        }
    }
    ...
    void registryShouldExposeRepresentativeNewToolSchemas() {
        ...
        assertThat(lspOperation).containsEntry("enum", java.util.List.of(
                "goToDefinition",
                "findReferences",
                "documentSymbol",
                "workspaceSymbol",
