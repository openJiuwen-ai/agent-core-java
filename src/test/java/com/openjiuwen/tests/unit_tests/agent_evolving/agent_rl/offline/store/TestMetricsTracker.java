 ...
 * <p>
 * Mirrors Python's {@code tests/unit_tests/agent_evolving/agent_rl/offline/store/test_metrics_tracker.py}.
 */
@DisplayName("MetricsTracker Tests")
class TestMetricsTracker {

    @Test
    @DisplayName("log step and finish no raise")
    void testLogStepAndFinishNoRaise() {
    ...
    @Test
    @DisplayName("log training step and rollout stats no raise")
    void testLogTrainingStepAndLogRolloutStatsNoRaise() {
        RLMetricsTracker tracker = new RLMetricsTracker("p", "e", List.of("tensorboard"));
