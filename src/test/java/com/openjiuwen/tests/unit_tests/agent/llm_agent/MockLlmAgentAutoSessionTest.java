 ...
 *
 * <p>Mirrors Python's {@code tests.unit_tests.agent.llm_agent.test_mock_llm_agent_auto_session}.</p>
 */
@DisplayName("Mock LlmAgent Auto Session Tests")
class MockLlmAgentAutoSessionTest {

    private static final String MOCK_PROVIDER = "MockBatch04AutoSessionOpenAI";
