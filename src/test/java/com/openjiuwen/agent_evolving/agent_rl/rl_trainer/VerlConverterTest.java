...
class VerlConverterTest {
    ...
    @Test
    void convertSamplesBuildsMasksScoresAndMetadata() {
        VerlConverter converter = new VerlConverter(new VerlConverter.Options().setPadTokenId(-1));

        VerlConverter.DataProto proto = converter.convertSamples(List.of(sample("s1", List.of(1, 2), List.of(3), List.of(-0.2), 0.7)));
    ...
    @Test
    void convertSamplesSplitsInputIdsByPromptWhenResponseMissing() {
        ...
        VerlConverter.DataProto proto = converter.convertSamples(List.of(sample));
    ...
    @Test
    void convertSamplesRejectsEmptyInputs() {
        VerlConverter converter = new VerlConverter();
