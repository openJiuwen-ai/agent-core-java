 ...
 *
 * <p>Note: A2AAgentCardAdapter source class requires translation before tests can be implemented.
 * Tests are disabled pending A2AAgentCardAdapter.java implementation.
 */
@Disabled("A2AAgentCardAdapter.java source class requires translation before tests can be implemented")
class TestA2aAgentcardAdapter {
     ...
     */
    static class TestToA2aAgentCard {

        @Test
        void testToA2aAgentCardShouldMapBasicFieldsAndDefaultModes() {
            // Placeholder - requires A2AAgentCardAdapter.java
        }
