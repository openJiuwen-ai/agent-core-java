...
/**
 * Hierarchical message-bus research team example.
 *
 * <p>Mirrors Python's {@code hierarchical_msgbus_research_team} in
 * {@code examples.multi_agent.builtin_teams}.</p>
 */
public final class HierarchicalMsgbusResearchTeamExample {

    public static final String TEAM_ID = "research_team_msgbus";
    ...
    public static final AgentCard STATISTICS_EXPERT_CARD = card(STATISTICS_EXPERT,
            "Statistics expert");
    public static final AgentCard LITERATURE_RESEARCHER_CARD = card(LITERATURE_RESEARCHER,
            "Literature researcher");
    public static final AgentCard DATA_ANALYST_CARD = card(DATA_ANALYST,
            "Data analyst");
    public static final AgentCard RESEARCH_DIRECTOR_CARD = card(RESEARCH_DIRECTOR,
            "Research director");

    private HierarchicalMsgbusResearchTeamExample() {
        // Utility class
    }
    ...
    public static final class LiteratureResearcher extends ExampleCommunicableAgent {
        ...
        @Override
        public Object invoke(Object inputs, Session session) {
            String topic = value(inputs, "topic");
            return Map.of(
