...
public class SecurityRail extends DeepAgentRail {
    ...
    /**
     * Security check before tool call.
     *
     * @param ctx the agent callback context
     */
    public void onBeforeToolCall(AgentCallbackContext ctx) {
        ...
        inputs.setToolMsg(ToolMessage.builder()
                ...
                .toolCallId(inputs.getToolCall() != null ? String.valueOf(inputs.getToolCall()) : "")
                .build());
    }
