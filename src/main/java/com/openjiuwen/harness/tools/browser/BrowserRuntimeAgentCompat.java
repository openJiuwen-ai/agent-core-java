  ...
  public static void ensureExecuteSignatureCompat(Object agent, long timeoutMillis) {
    try {
      ...
      Method method =
          abilityManager
              .getClass()
              .getMethod("execute", Object.class, Object.class, Object.class, Object.class);
      Object original =
          java.lang.reflect.Proxy.newProxyInstance(
              abilityManager.getClass().getClassLoader(),
      ...
      field.set(
          ...
          new Object() {
            /** Auto-generated for codecheck compliance. */
            public Object execute(Object ctx, Object toolCall, Object session, Object tag)
                throws Exception {
              ...
              try {
                ...
                throw new IllegalStateException(
                    "tool execution timeout after " + timeoutMillis + "ms", ex);
