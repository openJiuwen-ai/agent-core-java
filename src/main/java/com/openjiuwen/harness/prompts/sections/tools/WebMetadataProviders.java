...
final class WebMetadataProviders {
    ...
    static final class FreeSearchMetadataProvider implements ToolMetadataProvider {
        ...
        public String getDescription(String language) {
            return text(language,
                    "免费搜索，返回结果 URL 和摘要；如果 paid_search 可用或已配置 API，优先使用 paid_search。",
    ...
    static final class PaidSearchMetadataProvider implements ToolMetadataProvider {
        ...
        public String getDescription(String language) {
            return text(language,
                    "配置 API 时这是首选联网搜索工具；付费搜索支持 provider=auto|bocha|perplexity|serper|jina。",
            ...
            return ToolSchemaSupport.objectSchema(
                    ToolSchemaSupport.properties(new Object[] {
                            "query", ToolSchemaSupport.property("string", text(language,
                                    "付费搜索查询文本。", "Paid search query text.")),
                            "provider", Map.of(
                                    "type", "string",
                                    "description", "Provider: auto|bocha|perplexity|serper|jina.",
                                    "default", "auto"),
                            "max_results", Map.of(
                                    "type", "integer",
                                    "description", text(language, "最大 URL 数（1-20）。",
                                            "Maximum number of URLs (1-20)."),
                                    "default", 8),
                            "timeout_seconds", Map.of(
                                    "type", "integer",
                                    "description", text(language, "请求超时时间（秒，10-120）。",
    ...
    static final class FetchWebpageMetadataProvider implements ToolMetadataProvider {
        ...
        public String getDescription(String language) {
            return text(language,
                    "抓取网页文本，返回状态码、标题和正文文本。通常配合 paid_search 或 free_search 使用。",
        ...
        public Map<String, Object> getInputParams(String language) {
            return ToolSchemaSupport.objectSchema(
                    ToolSchemaSupport.properties(new Object[] {
                            "url", ToolSchemaSupport.property("string", text(language,
                                    "要抓取的网页 URL。", "Webpage URL to fetch.")),
                            "max_chars", Map.of(
                                    "type", "integer",
                                    "description", text(language,
                                            "返回内容最大字符数；设为 0 表示不截断。",
    ...
    private static Map<String, Object> querySchema(String language, String queryDescription,
            int defaultMaxResults, int defaultTimeout) {
        return ToolSchemaSupport.objectSchema(
                ToolSchemaSupport.properties(new Object[] {
                        "query", ToolSchemaSupport.property("string", queryDescription),
                        "max_results", Map.of(
                                "type", "integer",
                                "description", text(language, "最大结果数（1-20）。",
                                        "Maximum number of results (1-20)."),
                                "default", defaultMaxResults),
                        "timeout_seconds", Map.of(
                                "type", "integer",
                                "description", text(language, "请求超时时间（秒，5-60）。",
