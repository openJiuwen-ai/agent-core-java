...
public final class SessionsSpawnMetadataProvider implements ToolMetadataProvider {
    ...
    public Map<String, Object> getInputParams(String language) {
        ...
        properties.put("subagent_type", Map.of(
                "type", "string",
                "description", isEnglish ? "Subagent type" : "子代理类型"
        ));
        properties.put("task_description", Map.of(
                "type", "string",
                "description", isEnglish ? "Task description" : "任务描述"
        ));
        properties.put("parent_session_id", Map.of(
                "type", "string",
                "description", isEnglish ? "Parent session id for correlation" : "用于关联的父会话 ID"
        ));
        return Map.of(
                "type", "object",
