    ...
    public Map<String, Object> getInputParams(String language) {
        return ToolSchemaSupport.objectSchema(
                ToolSchemaSupport.properties(new Object[] {
                        "code", ToolSchemaSupport.property("string", text(language, "要执行的代码",
                                "Code to execute")),
                        "language", ToolSchemaSupport.property("string", text(language,
                                "编程语言，支持 python 或 javascript，默认 python",
