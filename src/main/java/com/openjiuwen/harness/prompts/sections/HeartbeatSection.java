...
/**
 * Mirrors Python's {@code build_heartbeat_section} in
 * {@code openjiuwen/harness/prompts/sections/heartbeat.py}.
 */
public final class HeartbeatSection {
    ...
    private static final String HEARTBEAT_SYSTEM_PROMPT_CN = """
            ## 心跳检测
    ...
    private static final String HEARTBEAT_SYSTEM_PROMPT_EN = """
            ## Heartbeat
    ...
    private static final Map<String, String> HEARTBEAT_SYSTEM_PROMPT = Map.of(
    ...
    public static String buildHeartbeatSystemPrompt(String language) {
        return HEARTBEAT_SYSTEM_PROMPT.getOrDefault(language, HEARTBEAT_SYSTEM_PROMPT_CN);
    }

    public static PromptSection buildHeartbeatSection(String language) {
        String resolvedLanguage = "en".equals(language) ? "en" : DEFAULT_LANGUAGE;
        return new PromptSection(
                SectionName.HEARTBEAT,
                Map.of(resolvedLanguage, buildHeartbeatSystemPrompt(resolvedLanguage)),
                PRIORITY
        );
    }

    public static PromptSection build(String language) {
        return buildHeartbeatSection(language);
    }

    public static PromptSection build() {
        return buildHeartbeatSection(DEFAULT_LANGUAGE);
    }
}
