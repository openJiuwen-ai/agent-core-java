...
/**
 * Mirrors Python's {@code openjiuwen.harness.prompts.tools.exit_worktree} in
 * {@code openjiuwen/harness/prompts/tools/exit_worktree.py}.
 */
public final class ExitWorktreePromptToolProviders {

    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    private static final TypeReference<Map<String, Object>> MAP_TYPE = new TypeReference<>() {
    };

    private ExitWorktreePromptToolProviders() {
    }
    ...
    public static final class ExitWorktreeMetadataProvider implements ToolMetadataProvider {
        ...
        public String getDescription(String language) {
            return resolve(EXITWORKTREEMETADATAPROVIDER_DESCRIPTION_CN, EXITWORKTREEMETADATAPROVIDER_DESCRIPTION_EN, language);
        }

        @Override
        public Map<String, Object> getInputParams(String language) {
            return parseSchema(resolve(EXITWORKTREEMETADATAPROVIDER_SCHEMA_CN, EXITWORKTREEMETADATAPROVIDER_SCHEMA_EN, language));
        }
    }
