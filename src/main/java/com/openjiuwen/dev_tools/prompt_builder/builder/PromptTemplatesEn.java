...
public final class PromptTemplatesEn {
     ...
     */
    public static final PromptTemplate PROMPT_BUILD_GENERAL_META_SYSTEM_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new SystemMessage("""
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_BUILD_GENERAL_META_USER_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_BUILD_PLAN_META_SYSTEM_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new SystemMessage("""
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_BUILD_PLAN_META_USER_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_FEEDBACK_INTENT_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
## Persona
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_FEEDBACK_GENERAL_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
## Persona
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_FEEDBACK_SELECT_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
## Persona
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_FEEDBACK_INSERT_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
## Role
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_BAD_CASE_ANALYZE_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
## Persona
...
""")))
     ...
     */
    public static final PromptTemplate PROMPT_BAD_CASE_OPTIMIZE_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("""
## Persona
...
""")))
     ...
     */
    public static final PromptTemplate FORMAT_BAD_CASE_TEMPLATE = PromptTemplate.builder()
            .content("""
[question]: {{question}}
