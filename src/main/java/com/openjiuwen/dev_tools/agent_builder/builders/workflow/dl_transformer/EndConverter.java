...
public class EndConverter extends BaseConverter {
    ...
    public EndConverter(Map<String, Object> nodeData, Map<String, Object> context, Position position) {
        super(nodeData, context, position);
    }

    @Override
    protected void convertSpecificConfig() {
        // End-specific configuration is covered by concrete converter tests elsewhere.
    }
}
