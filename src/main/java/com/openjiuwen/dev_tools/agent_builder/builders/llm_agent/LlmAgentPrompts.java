...
/**
 * Prompt constants for building LLM agents.
 *
...
public final class LlmAgentPrompts {
    ...
    public static final PromptTemplate USER_PROMPT_TEMPLATE = PromptTemplate.builder()
    ...
    public static final PromptTemplate GENERATE_USER_PROMPT_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("\n" + """
                    ## 背景信息
                    <用户输入信息>
                    {{user_message}}
    ...
    public static final PromptTemplate RESOURCE_USER_PROMPT_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("\n" + """
                    **Agent基础要素规划：**
                    {{agent_factor_info}}
    ...
    public static final PromptTemplate USER_INTENTION_PROMPT_TEMPLATE = PromptTemplate.builder()
            .content(List.of(new UserMessage("\n" + """
                    ## 输入信息
