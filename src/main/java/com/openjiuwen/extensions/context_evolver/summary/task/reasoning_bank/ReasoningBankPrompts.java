...
/**
 * Mirrors Python's {@code openjiuwen/extensions/context_evolver/summary/task/reasoning_bank/prompt.py}.
 */
public final class ReasoningBankPrompts {

    public static final String EXTRACT_SUCCESS_TRAJ_SYSTEM_PROMPT = """
You are an expert in generating reusable memories. \
...
You are an expert in evaluating the performance of an agent. \
