...
/**
 * Persist ReasoningBank vector nodes for the current user.
 * <p>
...
public class PersistMemoryOp extends BaseOp {
    ...
    private static final String ALGO_NAME = "rb";
    ...
    public CompletableFuture<Void> asyncExecute(RuntimeContext context) {
        ...
        if (allNodes.isEmpty()) {
            LOGGER.info("PersistMemoryOp (RB): no memories to persist for user=%s", userId);
