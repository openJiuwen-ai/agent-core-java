...
/**
 * Mirrors Python's {@code openjiuwen/extensions/context_evolver/summary/task/reme/prompt.py}.
 */
public final class ReMePrompts {

    public static final String COMPARATIVE_MEMORY_PROMPT = """
You are an expert AI analyst comparing higher-scoring and \
...
You are an expert AI analyst reviewing successful step sequences \
...
You are an expert AI analyst reviewing failed step sequences \
from an AI agent execution.
...
You are an expert AI analyst comparing multiple step \
...
You are an expert AI analyst tasked with validating the \
