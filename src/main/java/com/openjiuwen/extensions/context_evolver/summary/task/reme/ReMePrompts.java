 ...
 *
 * <p>Mirrors Python's {@code openjiuwen.extensions.context_evolver.summary.task.reme.prompt.ReMePrompts}.
 */
...
Your task is to compare and contrast these trajectories to identify the most useful and generalizable strategies as
memory items using self-contrast reasoning. Focus on critical decision points, technique variations, and approach differences.
