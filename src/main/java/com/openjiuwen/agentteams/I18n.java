 ...
 *
 * <p>Houses hard-coded user-facing strings that live inside runtime code paths
 * (dispatcher nudges, backend message content, default persona) so they can
 * be switched between Chinese and English without source edits.</p>
 */
public final class I18n {
    ...
    static {
        ...
        cn.put("team.shutdown_request_content", "\u5f53\u524d\u4efb\u52a1\u5df2\u5168\u90e8\u5b8c\u6210\uff0c\u8bf7\u7ed3\u675f\u6d41\u7a0b");
        cn.put("team.cancel_request_content",
                "\u5f53\u524d\u4efb\u52a1\u6709\u53d8\u52a8\uff0c\u8bf7\u505c\u6b62\u6267\u884c\u5f53\u524d\u4efb\u52a1\uff0c\u91cd\u65b0\u5c1d\u8bd5\u8ba4\u9886\u5408\u9002\u4efb\u52a1");
        cn.put("dispatcher.member_online", "[\u6210\u5458\u4e8b\u4ef6] \u6210\u5458 {0} \u5df2\u4e0a\u7ebf");
        cn.put("dispatcher.member_restarted", "[\u6210\u5458\u4e8b\u4ef6] \u6210\u5458 {0} \u5df2\u91cd\u542f (\u7b2c{1}\u6b21)");
        ...
        cn.put("dispatcher.stale_claim_header",
                "\u68c0\u6d4b\u5230\u4f60\u5df2\u8ba4\u9886\u4e14\u8d85\u8fc7 10 \u5206\u949f\u672a\u5b8c\u6210\u7684\u4efb\u52a1\uff08\u5171 {0} \u4e2a\uff09\uff0c\u8bf7\u7ee7\u7eed\u63a8\u8fdb\uff1a");
        cn.put("dispatcher.stale_claim_self",
                "[\u50ac\u4fc3] \u4f60\u5df2\u8ba4\u9886\u7684\u4efb\u52a1 [{0}] {1} \u5df2\u8d85\u8fc7 10 mins \u4ecd\u672a\u5b8c\u6210\uff0c\u8bf7\u7ee7\u7eed\u63a8\u8fdb\uff1a{2}");
        cn.put("dispatcher.task_assigned_to_self",
                "[\u4efb\u52a1\u6307\u6d3e] \u4efb\u52a1 [{0}] \u5df2\u6307\u6d3e\u7ed9\u4f60\uff0c\u8bf7\u901a\u8fc7 view_task \u5de5\u5177\u67e5\u770b\u4efb\u52a1\u8be6\u60c5\u5e76\u6267\u884c\u3002");
        ...
        cn.put("dispatcher.msg_received",
                "[\u6536\u5230{0}] message_id={1}, "
                        + "\u6765\u81ea: {2}\n"
                        + "\u5185\u5bb9: {3}\n"
                        + "\u63d0\u793a: \u5982\u679c\u5bf9\u65b9\u5728\u63d0\u95ee\u6216\u7b49\u5f85\u56de\u590d\uff0c\u8bf7\u52a1\u5fc5\u901a\u8fc7 send_message \u5de5\u5177\u56de\u590d {2}");
        cn.put("dispatcher.all_done_persistent",
                "\u6240\u6709\u4efb\u52a1\u5df2\u5b8c\u6210\u3002\u8bf7\u6c47\u603b\u672c\u8f6e\u5de5\u4f5c\u6210\u679c\u3002\u56e2\u961f\u7ee7\u7eed\u4fdd\u6301\u8fd0\u884c\uff0c\u7b49\u5f85\u65b0\u7684\u4efb\u52a1\u6307\u4ee4\u3002");
        cn.put("dispatcher.all_done_temporary",
                "\u6240\u6709\u4efb\u52a1\u5df2\u5b8c\u6210\u3002\u8bf7\u6c47\u603b\u56e2\u961f\u5de5\u4f5c\u6210\u679c\uff0c"
        ...
        cn.put("hitt.human_agent_spawned", "[\u6210\u5458\u4e8b\u4ef6] \u4eba\u7c7b\u6210\u5458 human_agent \u5df2\u52a0\u5165\u56e2\u961f");
        ...
        en.put("dispatcher.member_status_changed",
                "[Member Event] Member {0} status changed: {1} \u2192 {2}");
        ...
        en.put("dispatcher.task_assigned_to_self",
        ...
        en.put("dispatcher.teammate_task_list",
                "Current task list:\n"
    ...
    public static void setLanguage(Language lang) {
        if (lang == null || !STRINGS.containsKey(lang)) {
            throw new IllegalArgumentException(
                    "Unsupported language '" + lang + "'. Supported: " + STRINGS.keySet());
        }
