...
public final class ModelAllocators {
  ...
  public static ModelAllocator buildModelAllocator(TeamAgentSpec spec) {
    ...
    throw new IllegalArgumentException(
        "Unknown model_pool_strategy '"
            + strategy
            + "'; expected one of: round_robin, by_model_name");
  }

  /** Auto-generated for codecheck compliance. */
  public static TeamModelConfig resolveMemberModel(
      TeamAgentSpec spec, String modelName, Integer modelIndex) {
    if (spec == null
