 ...
 * <p>
 * When a member sends output to the leader via {@code send_message}, the
 ...
 * <p>
 * This replaces the unreliable "LLM checks its own inbox" pattern with a
...
public final class TeamResultCollector {
    ...
    public static void add(String teamName, String memberName, String content) {
        ...
        Loggers.AGENT.info("TeamResultCollector: recorded result from {} ({} chars) for team {}", memberName,
                content != null ? content.length() : 0, teamName);
    }
