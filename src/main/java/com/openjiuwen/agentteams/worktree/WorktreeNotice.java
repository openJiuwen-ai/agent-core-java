 ...
 *
 * <p>Mirrors Python worktree/notice.py.</p>
 */
public final class WorktreeNotice {
    ...
    public static String buildWorktreeNotice(Path parentCwd, Path worktreeCwd) {
        String parentPath = parentCwd != null && parentCwd.toString() != null
                ? parentCwd.toString() : "/";
        String worktreePath = worktreeCwd != null && worktreeCwd.toString() != null
                ? worktreeCwd.toString() : "/";
        ...
        return "## Git Worktree Isolation Notice\n\n"
                ...
                + parentPath + "`), translate them to your worktree root (`"
                + worktreePath + "`).\n"
                ...
                + "4. Use `EnterWorktreeTool` and `ExitWorktreeTool` to manage "
                + "worktree sessions if needed.\n";
    }
}
