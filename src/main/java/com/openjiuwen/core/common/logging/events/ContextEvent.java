 ...
 * Context 操作相关事件
 * 
 * <p>记录上下文添加消息、清除和检索的日志事件。
 * 
 * <p>对应 Python: events.py::ContextEvent
 */
public record ContextEvent(
    ...
    /**
     * 创建带默认值的 ContextEvent
     */
    public ContextEvent {
        if (eventId == null) eventId = UUID.randomUUID().toString();
        if (eventType == null) eventType = LogEventType.CONTEXT_ADD_MESSAGE;
        if (logLevel == null) logLevel = LogLevel.INFO;
        if (timestamp == null) timestamp = Instant.now();
        if (moduleType == null) moduleType = ModuleType.CONTEXT;
    ...
    public static class Builder {
        ...
        private LogEventType eventType = LogEventType.CONTEXT_ADD_MESSAGE;
        private LogLevel logLevel = LogLevel.INFO;
        private Instant timestamp;
        private ModuleType moduleType = ModuleType.CONTEXT;
        ...
        public Builder messageContent(String messageContent) { this.messageContent = messageContent; return this; }
        public Builder messageRole(String messageRole) { this.messageRole = messageRole; return this; }
        public Builder contextSize(Integer contextSize) { this.contextSize = contextSize; return this; }
        public Builder maxContextSize(Integer maxContextSize) { this.maxContextSize = maxContextSize; return this; }
        ...
        public ContextEvent build() {
            return new ContextEvent(
                ...
                messageType, messageContent, messageRole, contextSize, maxContextSize
            );
        }
    }
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("message_content", messageContent);
        result.put("message_role", messageRole);
        result.put("context_size", contextSize);
        result.put("max_context_size", maxContextSize);
