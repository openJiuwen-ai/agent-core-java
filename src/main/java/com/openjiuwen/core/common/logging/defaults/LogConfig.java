...
public class LogConfig {
    ...
    private Map<String, Object> getBaseConfig(String logFile, String output) {
        ...
        String fullLogFile = logPath.endsWith("/") || logPath.endsWith("\\")
            ? logPath + logFile
            : logPath + "/" + logFile;
        ...
        cfg.put("max_bytes", LoggingUtils.getLogMaxBytes(
            logConfig.getOrDefault("max_bytes", DefaultLogConstants.DEFAULT_MAX_BYTES)));
