 ...
 * <p>记录内存存储和检索的日志事件。
 * 
 * <p>对应 Python: events.py::MemoryEvent
 */
public record MemoryEvent(
    ...
    String query,
    Integer memoryCount,
    List<Map<String, Object>> retrievedMemories,
    Integer storageSizeBytes
    ...
    public MemoryEvent {
        ...
        if (eventType == null) eventType = LogEventType.MEMORY_STORE;
        if (logLevel == null) logLevel = LogLevel.INFO;
        if (timestamp == null) timestamp = Instant.now();
        if (moduleType == null) moduleType = ModuleType.MEMORY;
    ...
    public static class Builder {
        ...
        private LogEventType eventType = LogEventType.MEMORY_STORE;
        private LogLevel logLevel = LogLevel.INFO;
        private Instant timestamp;
        private ModuleType moduleType = ModuleType.MEMORY;
        ...
        public Builder memoryType(String memoryType) { this.memoryType = memoryType; return this; }
        ...
        public Builder memoryCount(Integer memoryCount) { this.memoryCount = memoryCount; return this; }
        public Builder retrievedMemories(List<Map<String, Object>> retrievedMemories) { this.retrievedMemories = retrievedMemories; return this; }
        public Builder storageSizeBytes(Integer storageSizeBytes) { this.storageSizeBytes = storageSizeBytes; return this; }
        ...
        public MemoryEvent build() {
            return new MemoryEvent(
                ...
                memoryType, operation, memoryId, query, memoryCount, retrievedMemories, storageSizeBytes
            );
        }
    }
    ...
    public Map<String, Object> toMap() {
        ...
        // Memory 特定字段
        result.put("memory_type", memoryType);
        result.put("operation", operation);
        result.put("memory_id", memoryId);
        result.put("query", query);
        result.put("memory_count", memoryCount);
        result.put("retrieved_memories", retrievedMemories);
        result.put("storage_size_bytes", storageSizeBytes);
