 ...
 * <p>记录检索操作的日志事件。
 * 
 * <p>对应 Python: events.py::RetrievalEvent
 */
public record RetrievalEvent(
    ...
    /**
     * 创建带默认值的 RetrievalEvent
     */
    public RetrievalEvent {
        if (eventId == null) eventId = UUID.randomUUID().toString();
        if (eventType == null) eventType = LogEventType.RETRIEVAL_START;
        if (logLevel == null) logLevel = LogLevel.INFO;
        if (timestamp == null) timestamp = Instant.now();
        if (moduleType == null) moduleType = ModuleType.RETRIEVAL;
    ...
    public static class Builder {
        ...
        private LogEventType eventType = LogEventType.RETRIEVAL_START;
        private LogLevel logLevel = LogLevel.INFO;
        private Instant timestamp;
        private ModuleType moduleType = ModuleType.RETRIEVAL;
        ...
        public Builder retrievalType(String retrievalType) { this.retrievalType = retrievalType; return this; }
        public Builder query(String query) { this.query = query; return this; }
        public Builder topK(Integer topK) { this.topK = topK; return this; }
        public Builder retrievedDocs(List<Map<String, Object>> retrievedDocs) { this.retrievedDocs = retrievedDocs; return this; }
        public Builder retrievalScore(Double retrievalScore) { this.retrievalScore = retrievalScore; return this; }
        ...
        public RetrievalEvent build() {
            return new RetrievalEvent(
                ...
                retrievalType, query, topK, retrievedDocs, retrievalScore, latencyMs, knowledgeBaseId
            );
        }
    }
    ...
    public Map<String, Object> toMap() {
        ...
        // Retrieval 特定字段
        result.put("retrieval_type", retrievalType);
        result.put("query", query);
        result.put("top_k", topK);
        result.put("retrieved_docs", retrievedDocs);
        result.put("retrieval_score", retrievalScore);
        result.put("latency_ms", latencyMs);
        result.put("knowledge_base_id", knowledgeBaseId);
