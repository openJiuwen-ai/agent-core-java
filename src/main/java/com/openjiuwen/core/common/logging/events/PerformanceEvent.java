 ...
 * <p>记录性能指标的日志事件。
 * 
 * <p>对应 Python: events.py::PerformanceEvent
 */
public record PerformanceEvent(
    ...
    /**
     * 创建带默认值的 PerformanceEvent
     */
    public PerformanceEvent {
        if (eventId == null) eventId = UUID.randomUUID().toString();
        if (eventType == null) eventType = LogEventType.PERFORMANCE_METRIC;
    ...
    public static class Builder {
        ...
        private LogEventType eventType = LogEventType.PERFORMANCE_METRIC;
        ...
        public Builder metricValue(Double metricValue) { this.metricValue = metricValue; return this; }
        public Builder metricUnit(String metricUnit) { this.metricUnit = metricUnit; return this; }
        ...
        public PerformanceEvent build() {
            return new PerformanceEvent(
                ...
                metricName, metricValue, metricUnit, resourceType, operation
            );
        }
    }
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("metric_value", metricValue);
        result.put("metric_unit", metricUnit);
