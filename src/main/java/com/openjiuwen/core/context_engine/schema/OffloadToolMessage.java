 ...
 */
public class OffloadToolMessage extends ToolMessage implements OffloadMessage {
    ...
    public OffloadToolMessage(String content, String offloadHandle, String offloadType, String toolCallId) {
        super(Objects.requireNonNull(content, "content"), Objects.requireNonNull(toolCallId, "toolCallId"));
