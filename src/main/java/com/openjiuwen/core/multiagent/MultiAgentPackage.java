...
public final class MultiAgentPackage {
    ...
    static {
        LAZY_EXPORTS.put("BaseTeam", "com.openjiuwen.core.multiagent.BaseTeam");
        LAZY_EXPORTS.put("TeamConfig", "com.openjiuwen.core.multiagent.TeamConfig");
        LAZY_EXPORTS.put("TeamCard", "com.openjiuwen.core.multiagent.schema.TeamCard");
        LAZY_EXPORTS.put("EventDrivenTeamCard", "com.openjiuwen.core.multiagent.schema.EventDrivenTeamCard");
