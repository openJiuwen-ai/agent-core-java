...
import com.openjiuwen.core.multiagent.teams.hierarchical_msgbus.SupervisorAgent;
...
public final class TeamsPackage {
    ...
    private static Map<String, Class<?>> exportedTypes() {
        ...
        exports.put("HierarchicalToolsTeam",
                com.openjiuwen.core.multiagent.teams.hierarchical_tools.HierarchicalTeam.class);
        exports.put("HierarchicalMsgbusTeam",
                com.openjiuwen.core.multiagent.teams.hierarchical_msgbus.HierarchicalTeam.class);
        exports.put("HierarchicalTeamConfig",
                com.openjiuwen.core.multiagent.teams.hierarchical_msgbus.HierarchicalTeamConfig.class);
