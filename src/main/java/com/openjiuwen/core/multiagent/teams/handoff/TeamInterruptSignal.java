...
/**
 * Signal that pauses the handoff chain and persists state for resumption.
 * <p>
 * Mirrors Python's {@code TeamInterruptSignal} in
 * {@code openjiuwen.core.multi_agent.teams.handoff.interrupt}.
 */
