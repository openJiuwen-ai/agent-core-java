...
/**
 * Package bridge for graph extraction prompt exports.
 *
 ...
 */
public final class GraphExtractionPromptsPackage {

    public static final String PYTHON_MODULE = "openjiuwen/core/memory/graph/extraction/prompts/__init__.py";

    public static final List<String> EXPORTED_SYMBOLS = List.of("TemplateManager");

    public static final Map<String, String> EXPORT_SOURCES = Map.of(
            "TemplateManager",
            "openjiuwen.core.memory.graph.extraction.prompts.manager.ThreadSafePromptManager"
    );

    public static final Map<String, Class<?>> JAVA_TYPES = Map.of(
            "TemplateManager", ThreadSafePromptManager.class
    );

    private GraphExtractionPromptsPackage() {
    }
