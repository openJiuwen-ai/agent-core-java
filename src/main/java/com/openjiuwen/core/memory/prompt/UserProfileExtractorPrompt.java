...
/**
 * Constants for user profile extractor prompts.
 * <p>
 * Corresponds to Python: prompt/user_profile_extractor.py
 */
public final class UserProfileExtractorPrompt {

    private UserProfileExtractorPrompt() {
        // Utility class, no instantiation
    }

    public static final String USER_PROFILE_EXTRACTOR_PROMPT = """
