...
/**
 * Constants for variable extractor prompts.
 * <p>
 * Corresponds to Python: prompt/variable_extractor.py
 */
public final class VariableExtractorPrompt {

    private VariableExtractorPrompt() {
        // Utility class, no instantiation
    }

    public static final String EXTRACT_VARIABLES_PROMPT = """
# 任务描述
假设你是信息提取领域专家。
# 任务定义
