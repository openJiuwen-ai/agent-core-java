...
/**
 * Constants for categorizer prompts.
 * <p>
 * Corresponds to Python: prompt/categorizer.py
 */
public final class CategorizerPrompt {

    private CategorizerPrompt() {
        // Utility class, no instantiation
    }

    public static final String CATEGORIZATION_PROMPT = """
# 任务描述
