...
/**
 * Constants for conflict resolution prompts.
 * <p>
 * Corresponds to Python: prompt/conflict_resolution.py
 */
public final class ConflictResolutionPrompt {

    private ConflictResolutionPrompt() {
        // Utility class, no instantiation
    }

    public static final String CONFLICT_RESOLUTION_PROMPT = """
# 任务描述
