 ...
 * <p>
 * Mirrors Python's {@code TaskExecutor(ABC)} in
...
public abstract class TaskExecutor {
     ...
     */
    public Iterator<ControllerOutputChunk> execute(String taskId, AgentSessionApi session) {
        return executeAbility(taskId, session);
    }

    /**
     * Execute a task through the Java scheduler compatibility entrypoint.
     *
     * @param taskId  task identifier
     * @param session session object
     * @return iterator of output chunks produced during execution
     ...
     *
     * <p>Mirrors Python's {@code TaskExecutor.can_pause} tuple return in
     ...
     *
     * <p>Mirrors Python's {@code TaskExecutor.can_cancel} tuple return in
     * {@code openjiuwen/core/controller/modules/task_executor.py}.</p>
     */
