...
/**
 * Mirrors Python's {@code openjiuwen/agent_evolving/optimizer/skill_call/templates.py}.
 */
public final class SkillCallTemplates {

    public static final String SKILL_EXPERIENCE_GENERATE_PROMPT_CN = """
...
""";
    ...
    public static final String SKILL_EXPERIENCE_GENERATE_PROMPT_EN = """
...
""";
    ...
    public static final String JSON_FIX_PROMPT = """
...
""";
    ...
    public static final String JSON_FIX_PROMPT_STRICT = """
...
""";
    ...
    public static final String USER_PATCH_PROMPT_CN = """
...
""";
    ...
    public static final String USER_PATCH_PROMPT_EN = """
...
""";
    ...
    public static final String TRAJECTORY_PATCH_PROMPT_CN = """
...
""";
    ...
    public static final String TRAJECTORY_PATCH_PROMPT_EN = """
...
""";
    ...
    public static final String TEAM_EXPERIENCE_GENERATE_PROMPT_CN = """
...
""";
    ...
    public static final String TEAM_EXPERIENCE_GENERATE_PROMPT_EN = """
...
""";
    ...
    public static final String TEAM_JSON_FIX_PROMPT = """
你上次的输出不是合法 JSON，请修复并重新输出。
只输出修复后的 JSON 数组，不要任何解释文字。
...
""";
    ...
    public static final String TEAM_JSON_FIX_PROMPT_STRICT = """
你的 JSON 输出多次解析失败。请完全重新生成。
...
""";
    ...
    );     public static final Map<String, String> USER_PATCH_PROMPT = Map.of(
            "cn", USER_PATCH_PROMPT_CN,
            "en", USER_PATCH_PROMPT_EN
    );     public static final Map<String, String> TRAJECTORY_PATCH_PROMPT = Map.of(
            "cn", TRAJECTORY_PATCH_PROMPT_CN,
            "en", TRAJECTORY_PATCH_PROMPT_EN
    );     public static final Map<String, String> TEAM_EXPERIENCE_GENERATE_PROMPT = Map.of(
            "cn", TEAM_EXPERIENCE_GENERATE_PROMPT_CN,
            "en", TEAM_EXPERIENCE_GENERATE_PROMPT_EN
    );

    private SkillCallTemplates() {
    }
}
