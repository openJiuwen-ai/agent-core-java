...
/**
 * Single turn sample from a trajectory.
 * <p>
 * Mirrors Python's {@code PerTurnSample} dataclass in converter.py.
 */
public class PerTurnSample {
    ...
    public PerTurnSample(String trajectoryId, int stepIndex, String sessionId, String modelId,
                         List<Map<String, Object>> messages, Map<String, Object> response,
                         String responseText, List<Integer> responseTokens, List<Double> logprobs,
                         List<Integer> promptIds, Map<String, Object> renderFingerprint,
                         Object tools, Map<String, Object> meta) {
        ...
        this.renderFingerprint = renderFingerprint != null ? renderFingerprint : new LinkedHashMap<>();
        this.tools = tools;
    ...
    public List<Integer> getResponseTokens() { return responseTokens; }
    public List<Double> getLogprobs() { return logprobs; }
    public List<Integer> getPromptIds() { return promptIds; }
    public Map<String, Object> getRenderFingerprint() { return renderFingerprint; }
    ...
    public static final class Builder {
        ...
        public Builder responseTokens(List<Integer> responseTokens) { this.responseTokens = responseTokens; return this; }
        public Builder logprobs(List<Double> logprobs) { this.logprobs = logprobs; return this; }
        public Builder promptIds(List<Integer> promptIds) { this.promptIds = promptIds; return this; }
        public Builder renderFingerprint(Map<String, Object> renderFingerprint) { this.renderFingerprint = renderFingerprint; return this; }
