...
public final class EnLocaleStrings {
    ...
    private static Map<String, String> buildStrings() {
        ...
        map.put("create_task.task.assignee",
                "Optional teammate member_name; omit to leave the task in the shared claim pool. "
                        + "Lands as pending with this assignee (assigned, not yet started)");
