 ...
 * <p>
 * Mirrors Python's {@code GitHubCliStatus} in
 * {@code openjiuwen/auto_harness/infra/github_cli.py}.
 */
public class GitHubCliStatus {
    ...
    public boolean isInstalledNow() {
        return installedNow;
    }

    public void setInstalledNow(boolean installedNow) {
        this.installedNow = installedNow;
    }
