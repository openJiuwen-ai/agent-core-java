 ...
 *
 * <p>Mirrors Python's {@code TaskRuntime} in {@code openjiuwen.auto_harness.contexts.execution}.</p>
 */
public class TaskRuntime {
    ...
    public void setPreexistingDirtyFiles(List<String> preexistingDirtyFiles) {
        this.preexistingDirtyFiles = preexistingDirtyFiles != null ? preexistingDirtyFiles : new ArrayList<>();
    }
