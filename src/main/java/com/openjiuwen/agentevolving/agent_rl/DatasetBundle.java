 ...
 *
 * <p>Mirrors Python's {@code DatasetBundle} in
...
public class DatasetBundle {
    ...
    public void setTrainDataset(Object trainDataset) {
        this.trainDataset = trainDataset;
    }
    ...
    public void setValDataset(Object valDataset) {
        this.valDataset = valDataset;
    }

    public Function<Object[], Object> getCollateFn() {
        return collateFn;
    }

    public void setCollateFn(Function<Object[], Object> collateFn) {
        this.collateFn = collateFn;
    }

    public Object getTrainSampler() {
        return trainSampler;
    }

    public void setTrainSampler(Object trainSampler) {
        this.trainSampler = trainSampler;
    }

    public Runnable getCleanupFn() {
        return cleanupFn;
    }

    public void setCleanupFn(Runnable cleanupFn) {
