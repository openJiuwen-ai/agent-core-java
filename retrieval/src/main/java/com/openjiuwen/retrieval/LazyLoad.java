...
public final class LazyLoad {
    ...
    private static Map<String, String> parserJavaSymbols() {
        ...
        javaSymbols.put("HTMLFileParser",
                "com.openjiuwen.retrieval.indexing.processor.parser.HTMLFileParser");
        ...
        javaSymbols.put("parse_wechat_article_url",
                "com.openjiuwen.retrieval.indexing.processor.parser.WeChatArticleParser#parseWechatArticleUrl");
        javaSymbols.put("parse_web_page_url",
                "com.openjiuwen.retrieval.indexing.processor.parser.WebPageParser#parseWebPageUrl");
    ...
    private static Map<String, String> retrievalJavaSymbols() {
        ...
        symbols.put("KnowledgeBaseConfig", "com.openjiuwen.retrieval.common.KnowledgeBaseConfig");
        symbols.put("RetrievalConfig", "com.openjiuwen.retrieval.common.RetrievalConfig");
        symbols.put("IndexConfig", "com.openjiuwen.retrieval.common.IndexConfig");
        ...
        symbols.put("RerankerConfig", "com.openjiuwen.retrieval.common.RerankerConfig");
        ...
        symbols.put("TextChunk", "com.openjiuwen.retrieval.common.TextChunk");
        symbols.put("MultiKBRetrievalResult", "com.openjiuwen.retrieval.common.MultiKBRetrievalResult");
        ...
        symbols.put("Triple", "com.openjiuwen.retrieval.common.Triple");
        symbols.put("TripleBeam", "com.openjiuwen.retrieval.common.TripleBeam");
        symbols.put("TripleMemory", "com.openjiuwen.retrieval.common.TripleMemory");
        symbols.put("BaseCallback", "com.openjiuwen.core.retrieval.common.BaseCallback");
        symbols.put("TqdmCallback", "com.openjiuwen.retrieval.common.TqdmCallback");
        ...
        symbols.put("create_vector_store",
                "com.openjiuwen.retrieval.vector_store.VectorStoreFactory#createVectorStore");
        symbols.put("Indexer", "com.openjiuwen.retrieval.indexing.indexer.Indexer");
        symbols.put("Processor", "com.openjiuwen.retrieval.indexing.processor.Processor");
        symbols.put("Chunker", "com.openjiuwen.retrieval.indexing.processor.chunker.Chunker");
        symbols.put("Extractor", "com.openjiuwen.retrieval.indexing.processor.extractor.Extractor");
        symbols.put("Splitter", "com.openjiuwen.retrieval.indexing.processor.splitter.Splitter");
        symbols.put("SentenceSplitter", "com.openjiuwen.retrieval.indexing.processor.splitter.SentenceSplitter");
        symbols.put("TextSplitter", "com.openjiuwen.retrieval.indexing.processor.chunker.TextSplitter");
        symbols.put("CharSplitter", "com.openjiuwen.retrieval.indexing.processor.chunker.CharSplitter");
        symbols.put("IndexSentenceSplitter",
                "com.openjiuwen.retrieval.indexing.processor.chunker.IndexSentenceSplitter");
        symbols.put("TextPreprocessor", "com.openjiuwen.retrieval.indexing.processor.chunker.TextPreprocessor");
        symbols.put("WhitespaceNormalizer",
                "com.openjiuwen.retrieval.indexing.processor.chunker.WhitespaceNormalizer");
        symbols.put("URLEmailRemover", "com.openjiuwen.retrieval.indexing.processor.chunker.URLEmailRemover");
        ...
        symbols.put("TextChunker", "com.openjiuwen.retrieval.indexing.processor.chunker.TextChunker");
        symbols.put("CharChunker", "com.openjiuwen.retrieval.indexing.processor.chunker.CharChunker");
        symbols.put("HybridChunker", "com.openjiuwen.retrieval.indexing.processor.chunker.HybridChunker");
        symbols.put("get_chunker",
                "com.openjiuwen.retrieval.indexing.processor.chunker.ChunkerRegistry#getChunker");
        symbols.put("register_chunker",
                "com.openjiuwen.retrieval.indexing.processor.chunker.ChunkerRegistry#registerChunker");
        symbols.put("TokenizerChunker", "com.openjiuwen.retrieval.indexing.processor.chunker.TokenizerChunker");
        symbols.put("TripleExtractor", "com.openjiuwen.retrieval.indexing.processor.extractor.TripleExtractor");
        symbols.put("Retriever", "com.openjiuwen.retrieval.retriever.Retriever");
        symbols.put("VectorRetriever", "com.openjiuwen.retrieval.retriever.VectorRetriever");
        symbols.put("SparseRetriever", "com.openjiuwen.retrieval.retriever.SparseRetriever");
        symbols.put("HybridRetriever", "com.openjiuwen.retrieval.retriever.HybridRetriever");
        symbols.put("GraphRetriever", "com.openjiuwen.retrieval.retriever.GraphRetriever");
        symbols.put("AgenticRetriever", "com.openjiuwen.retrieval.retriever.AgenticRetriever");
        symbols.put("ConfigManager", "com.openjiuwen.retrieval.utils.ConfigManager");
        symbols.put("rrf_fusion", "com.openjiuwen.retrieval.utils.FusionUtils#rrfFusionRetrieval");
        symbols.put("deduplicate", "com.openjiuwen.retrieval.utils.CommonUtils#deduplicate");
        ...
        symbols.put("MilvusVectorStore", "com.openjiuwen.retrieval.vector_store.MilvusVectorStore");
        symbols.put("MilvusIndexer", "com.openjiuwen.retrieval.indexing.indexer.MilvusIndexer");
        symbols.put("ChromaIndexer", "com.openjiuwen.retrieval.indexing.indexer.ChromaIndexer");
        symbols.put("ChromaVectorStore", "com.openjiuwen.retrieval.vector_store.ChromaVectorStore");
        symbols.put("ChromaVectorField", "com.openjiuwen.core.foundation.store.vector_fields.ChromaVectorField");
        symbols.put("OpenAIEmbedding", "com.openjiuwen.retrieval.embedding.OpenAIEmbedding");
        symbols.put("VLLMEmbedding", "com.openjiuwen.retrieval.embedding.VLLMEmbedding");
        symbols.put("DashscopeEmbedding", "com.openjiuwen.retrieval.embedding.DashscopeEmbedding");
        symbols.put("parse_base64_embedding",
                "com.openjiuwen.retrieval.embedding.EmbeddingUtils#parseBase64Embedding");
        symbols.put("StandardReranker", "com.openjiuwen.core.retrieval.reranker.StandardReranker");
        symbols.put("ChatReranker", "com.openjiuwen.retrieval.reranker.ChatReranker");
        symbols.put("DashscopeReranker", "com.openjiuwen.retrieval.reranker.DashscopeReranker");
        symbols.put("AutoFileParser", "com.openjiuwen.retrieval.indexing.processor.parser.AutoFileParser");
        symbols.put("AutoLinkParser", "com.openjiuwen.retrieval.indexing.processor.parser.AutoLinkParser");
        symbols.put("AutoParser", "com.openjiuwen.retrieval.indexing.processor.parser.AutoParser");
        symbols.put("ExcelParser", "com.openjiuwen.retrieval.indexing.processor.parser.ExcelParser");
        symbols.put("Parser", "com.openjiuwen.retrieval.indexing.processor.parser.Parser");
        symbols.put("JSONParser", "com.openjiuwen.retrieval.indexing.processor.parser.JsonParser");
        symbols.put("PDFParser", "com.openjiuwen.retrieval.indexing.processor.parser.PDFParser");
        symbols.put("ImageParser", "com.openjiuwen.retrieval.indexing.processor.parser.ImageParser");
        symbols.put("TxtMdParser", "com.openjiuwen.retrieval.indexing.processor.parser.TxtMdParser");
        symbols.put("WebPageParser", "com.openjiuwen.retrieval.indexing.processor.parser.WebPageParser");
        symbols.put("WeChatArticleParser", "com.openjiuwen.retrieval.indexing.processor.parser.WeChatArticleParser");
        symbols.put("WordParser", "com.openjiuwen.retrieval.indexing.processor.parser.WordParser");
        symbols.put("KnowledgeBase", "com.openjiuwen.retrieval.KnowledgeBase");
        symbols.put("SimpleKnowledgeBase", "com.openjiuwen.retrieval.SimpleKnowledgeBase");
        symbols.put("GraphKnowledgeBase", "com.openjiuwen.retrieval.GraphKnowledgeBase");
        symbols.put("retrieve_multi_kb", "com.openjiuwen.retrieval.SimpleKnowledgeBase#retrieveMultiKb");
        symbols.put("retrieve_multi_kb_with_source",
                "com.openjiuwen.retrieval.SimpleKnowledgeBase#retrieveMultiKbWithSource");
        symbols.put("QueryRewriter", "com.openjiuwen.retrieval.query_rewriter.QueryRewriter");
